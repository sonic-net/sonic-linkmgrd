...
TEST_F(MuxPortTest, TestSwssBladeIpv4AddressUpdateHandler)
{
    ...
    for (uint i = 0, called = 0; i < 10000; ++i)
    {
        ...
        while (fakeLinkManagerStateMachinePtr->mSwssBladeIpv4AddressUpdateHandlerCalled < called)
        {
            usleep(1000);
        }
...
TEST_F(MuxPortTest, TestSocIpv4AddressUpdateHandler)
{
    ...
    for (uint i = 0, called = 0; i < 10000; ++i)
    {
        ...
        while (fakeLinkManagerStateMachinePtr->mSwssSoCIpv4AddressUpdateHandlerCalled < called)
        {
            usleep(1000);
        }
...
TEST_F(MuxPortTest, TestGetServerMacAddressHandler)
{
    ...
    for (uint i = 0, called = 0; i < 10000; ++i)
    {
        ...
        while (fakeLinkManagerStateMachinePtr->mGetServerMacAddressNotificationHandlerCalled < called)
        {
            usleep(1000);
        }
...
TEST_F(MuxPortTest, TestGetMuxStateNotificationHandler)
{
    ...
    for (uint i = 0, called = 0; i < 10000; ++i)
    {
        ...
        while (fakeLinkManagerStateMachinePtr->mGetMuxStateNotificationHandlerCalled < called)
        {
            usleep(1000);
        }
...
TEST_F(MuxPortTest, TestProbeMuxStateNotificationHandler)
{
    ...
    for (uint i = 0, called = 0; i < 10000; ++i)
    {
        ...
        while (fakeLinkManagerStateMachinePtr->mProbeMuxStateNotificationHandlerCalled < called)
        {
            usleep(1000);
        }
...
TEST_F(MuxPortTest, TestMuxStateNotificationHandler)
{
    ...
    for (uint i = 0, called = 0; i < 10000; ++i)
    {
        ...
        while (fakeLinkManagerStateMachinePtr->mMuxStateNotificationHandlerCalled < called)
        {
            usleep(1000);
        }
...
TEST_F(MuxPortTest, TestSwssLinkStateNotificationHandler)
{
    ...
    for (uint i = 0, called = 0; i < 10000; ++i)
    {
        ...
        while (fakeLinkManagerStateMachinePtr->mSwssLinkStateNotificationHandlerCalled < called)
        {
            usleep(1000);
        }
