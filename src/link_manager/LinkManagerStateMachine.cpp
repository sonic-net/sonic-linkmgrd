...
// 
void LinkManagerStateMachine::handleSrcMacConfigNotification()
{
...
//
void LinkManagerStateMachine::handleDefaultRouteStateNotification(const DefaultRoute routeState)
{
    MUXLOGDEBUG(mMuxPortConfig.getPortName());
