...
)
{
    ...
    if (!errorCode)
    {
        ...
        if (isProberHw)
        {
            (static_cast<LinkProberHw *>(this))->handleIcmpPayload(bytesTransferred, icmpHeader, icmpPayload);
        } else {
...
void LinkProberBase::handleTlvRecv(size_t bytesTransferred, bool isSelfGuid)
{
