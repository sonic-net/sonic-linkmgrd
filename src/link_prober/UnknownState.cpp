...
//
LinkProberState* UnknownState::handleEvent(LinkProberSelfUpEvent &event)
{
    MUXLOGDEBUG(getMuxPortConfig().getPortName());
...
//
LinkProberState* UnknownState::handleEvent(LinkProberSelfDownEvent &event)
{
    MUXLOGDEBUG(getMuxPortConfig().getPortName());
...
//
LinkProberState* UnknownState::handleEvent(LinkProberPeerUpEvent &event)
{
    MUXLOGDEBUG(getMuxPortConfig().getPortName());
...
//
LinkProberState* UnknownState::handleEvent(LinkProberPeerDownEvent &event)
{
    MUXLOGDEBUG(getMuxPortConfig().getPortName());
